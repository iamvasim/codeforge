...
const Register = () => {
    ...
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-[#080810] text-[#f4f4f5] font-sans px-4 overflow-hidden">
            ...
            <div className='absolute top-[-120px] right-[-120px] w-[520px] h-[520px] rounded-full bg-fuchsia-700/20 blur-[110px] pointer-events-none' />
            <div className='absolute bottom-[-120px] left-[-120px] w-[520px] h-[420px] rounded-full bg-violet-700/15 blur-[110px] pointer-events-none' />
            ...
            <div className="relative w-full max-w-md px-4 z-10">
                <div className="glass-modal p-8 rounded-2xl shadow-2xl space-y-6">
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-sm text-zinc-400">Join CodeForge to start building and collaborating</p>
                    </div>
